...
addLayer("e", {
    ...
    doReset(resettingLayer){
        ...
        if (layers[resettingLayer].row >= this.row && !this.layer) layerDataReset(this.layer, keep)
    ...
    effect(){
        ...
        eff = eff.pow(2)
        if (eff.gte(Decimal.pow(10,15)) && !hasUpgrade("t",11)) eff = Decimal.pow(10,eff.div(Decimal.pow(10,5)).log10().pow(0.88)).mul(Decimal.pow(10,5))
        ...
        if (hasUpgrade("t", 11)){
            if (eff.gte(Decimal.pow(10,15).times(upgradeEffect('t', 11)))) eff = Decimal.pow(10,eff.div(Decimal.pow(10,5)).log10().pow(0.88)).mul(Decimal.pow(10,5))}
    ...
    achievements: {
        ...
        23: {
            ...
            tooltip: "Have 1.798e308 particles.<br>Reward: 2 AP<br>Next achievement: 1 atom",
                ...
                return player.points.gte(1.000e308).times(18).div(10)
            },
            onComplete() {
                addPoints("a",2)
            }
